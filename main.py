...
# Lista plików do załadowania - DODANO cogs.profile, cogs.games, cogs.nsfw
COGS = ['cogs.admin', 'cogs.economy', 'cogs.social', 'cogs.general', 'cogs.levels', 'cogs.profile', 'cogs.games', 'cogs.tickets', 'cogs.events', 'cogs.verification', 'cogs.nsfw']
